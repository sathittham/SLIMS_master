...
public class FusedSensorsActivity extends Activity implements
		FusedGyroscopeSensorObserver, GravitySensorObserver,
		MagneticSensorObserver, GyroscopeSensorObserver {


		public static final float EPSILON = 0.000000001f;

		private static final String tag = FusedSensorsActivity.class
				.getSimpleName();
		...
		private TextView azimuthAndroid;
		private TextView azimuthFused;
		...
		protected void onCreate(Bundle savedInstanceState)
		{
			...
			setContentView(R.layout.activity_fused_sensors);
		...
		public boolean onCreateOptionsMenu(Menu menu)
		{
			...
			getMenuInflater().inflate(R.menu.fused_sensors, menu);
			return true;
		}
		...
		public void onGyroscopeSensorChanged(float[] gyroscope, long timestamp)
		{
			...
			xAxisAndroid.setText(df.format(gyroscopeOrientationAndroid[0] * 180/Math.PI));
			yAxisAndroid.setText(df.format(gyroscopeOrientationAndroid[1] * 180/Math.PI));
			zAxisAndroid.setText(df.format(gyroscopeOrientationAndroid[2]));
			
			//azimuthAndroid.setText(df.format(value));
		}
		...
		private void initUI()
		{
			...
			azimuthAndroid = (TextView) this.findViewById(R.id.fused_sensors_azimuth_value);
			...
			azimuthFused = (TextView) this.findViewById(R.id.none_fused_sensors_azimuth_value);
